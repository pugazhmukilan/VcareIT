...
class Signinpage extends StatefulWidget {
  final type;
   ...
   Signinpage({super.key,required this.type});

  @override
  State<Signinpage> createState() => _SigninpageState(type:type);
}
...
class _SigninpageState extends State<Signinpage> {
  ...
  final type;
  _SigninpageState({required this.type});
                        ...
                        const SizedBox(
                          ...
                          child: Hero(
                            ...
                            child: Image(
                                ...
                                image: AssetImage('assets/VcareIT.png',),height: 130,
                                                      ),),
                        ),
                        AnimatedTextKit(
                    animatedTexts: [
                    ...
                    /*Padding(
                      ...
                      child: GestureDetector(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            backgroundColor: Color.fromARGB(96, 0, 124, 178),
                            content: Column(
                          ...
                          try{
                           ...
                           // print(emailcontroller.text);
                            ...
                            print("PRINTING  USENAME    ================= ${UserName}");
                            }
                            
                            Navigator.pop(context);
                            if (type =="Student Login")
                            Navigator.push(context,MaterialPageRoute(builder: (context)=>Home()));
                            if (type == "CareTaker Login")
                            Navigator.push(context,MaterialPageRoute(builder: (context)=>CareHome()));
